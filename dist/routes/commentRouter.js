...
const commentModel = __importStar(require("../models/comment"));
var jsonParser = body_parser_1.default.json();
const commentRouter = express_1.default.Router();
exports.commentRouter = commentRouter;
commentRouter.post("/", jsonParser, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
commentRouter.get("/:post_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
